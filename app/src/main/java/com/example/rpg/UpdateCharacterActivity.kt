...
import com.example.rpg.AppApplication
...
class UpdateCharacterActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.update_character)
        ...
        CoroutineScope(Dispatchers.IO).launch {
            character = (application as AppApplication).db.characterDao().getCharacterById(characterId) ?: return@launch
    ...
    private fun updateCharacter() {
        ...
        CoroutineScope(Dispatchers.IO).launch {
            (application as AppApplication).db.characterDao().update(updatedCharacter)
